...
return [
    ...
    'web'                            =>[
        ...
        'aksam' => 'النهار',
        'yatsi' => 'العشاء',
        'ne'    => 'ما هو كيفية استخدامه',
        'uygulama' => ' تطبيق imsakiye هو تطبيق بسيط تم تطويره للحصول على أوقات الصلاة وقائمة وتنزيلها بسهولة للطابعات والمصممين وجميع المستخدمين.        ',
        'kullanim' => 'يستخدم',
        'kullanim_yazi' => 'من السهل جدًا استخدامه ، وتسجيل الدخول بسرعة ، وتحديد البلد ، والمقاطعة ، والمنطقة ، وتحديد تاريخ البدء المطلوب ، وكتابة عدد أوقات الصلاة اليومية ، وهذا كل شيء.'
